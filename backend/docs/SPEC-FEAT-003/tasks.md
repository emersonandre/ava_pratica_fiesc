...
- [x] Script de auditoria: correlação e razão entre pares de unidade, salvo em `backend/docs/analise/features.md`
...
- [x] Documentar em `backend/docs/analise/features.md` cada coluna descartada e o porquê
